...
const FEED_CARD_SELECT_FIELDS_BASE =
  "id, item_name, market_hash_name, category, buy_market, buy_price, sell_market, sell_net, profit, spread_pct, opportunity_score, execution_confidence, quality_grade, liquidity_label, created_at, detected_at, discovered_at, first_seen_at, last_seen_at, last_published_at, times_seen, opportunity_fingerprint, material_change_hash, feed_published_at, scan_run_id, is_active, is_duplicate, refresh_status, live_status, latest_signal_age_hours, verdict, item_id:metadata->>item_id, item_subcategory:metadata->>item_subcategory, item_canonical_rarity:metadata->>item_canonical_rarity, item_rarity:metadata->>item_rarity, item_rarity_color:metadata->>item_rarity_color, item_rarity_unknown_reason:metadata->>item_rarity_unknown_reason, item_rarity_resolution_source:metadata->>item_rarity_resolution_source, item_image_url:metadata->>item_image_url, volume_7d:metadata->>volume_7d, market_coverage:metadata->>market_coverage, reference_price:metadata->>reference_price, buy_url:metadata->>buy_url, sell_url:metadata->>sell_url, score_category:metadata->>score_category, quality_score_display:metadata->>quality_score_display, flags:metadata->flags, badges:metadata->badges, metadata"
